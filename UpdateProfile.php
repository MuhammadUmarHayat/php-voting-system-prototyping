   ...
   die('Password and Confirm password should match!');   
	 ...
	 $code =$_POST['code'];
		...
		echo  $userid = $_GET['id']; 
		 ...
		 $query="UPDATE `admins` SET `password`='$password', name='$name' WHERE `adminid`='$userid' and `secCode`='$code'";
...
<tr> <td>Enter your Name</td> <td><input type="text" name="name" required>   <span class="error" >*</span > </td>   </tr>
